    ...
    <MDBRow className='row-cols-1 row-cols-md-3 g-4'>
      <MDBCol>
        ...
        <MDBCard class= ".card-img-top" alignment='center'>
          ...
          <MDBCardBody>
            <MDBCardTitle> 
              <a href="https://anthonyplanisek.github.io/Project-1/">Inspired Meal Prep</a>
            </MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCol>
        ...
        <MDBCard class= ".card-img-top" alignment='center'>
          ...
          />
          <MDBCardBody>
            <MDBCardTitle>            <a href="https://dream-vacation2021.herokuapp.com/">Traveler's Landing Link</a>
</MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCard class= ".card-img-top" alignment='center'>
          ...
          />
          <MDBCardBody>
            <MDBCardTitle>            <a href="https://uncvalladareshamlet.github.io/Password_Generator/">Password Generator </a>
</MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCard class= ".card-img-top" alignment='center'>
          ...
          />
          <MDBCardBody>
            <MDBCardTitle>            <a href="https://note-taker-app44.herokuapp.com/">Note Taker</a>
</MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCard class= ".card-img-top" alignment='center'>
          ...
          />
          <MDBCardBody>
            <MDBCardTitle>            <a href="https://uncvalladareshamlet.github.io/HW_5_WorkDayScheduler/">Workday Scheduler </a>
</MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCard class= ".card-img-top" alignment='center'>
          ...
          />
          <MDBCardBody>
            <MDBCardTitle>            <a href="https://fast-fjord-59620.herokuapp.com/">Fitness Tracker</a>
</MDBCardTitle>
            <MDBCardText>
